...
Safe deletion exercises and later transaction-management topics will be added
...
every update should be checked with a targeted `SELECT` before and after it runs.

## Next steps

- Add safe `DELETE` exercises
